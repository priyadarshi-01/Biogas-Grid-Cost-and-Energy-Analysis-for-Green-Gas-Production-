...
Applied the model to two Rajasthan districts (Kota, Bikaner), using government livestock and agricultural data to estimate
feedstock availability and system scale.

Built a business case showing shared upgrading hubs improve economic viability for small-scale producers, and identified a
cost-efficient centralized upgrading strategy for scalable adoption
